...
//TODO: adapt for API3 feed insurance model
//TODO: compare with https://github.com/lexDAO/LexCorpus/blob/master/contracts/escrow/lexlocker/solidity/LexLocker.sol (and adapt for >=0.8)
...
contract insuranceClaim is IArbitrable, IEvidence {
    ...
    uint256 public constant reclamationPeriod = 10 minutes;
    uint256 public constant arbitrationFeeDepositPeriod = 10 minutes;
    ...
    //initial with payee, arbitrator, and metaevidence; user may elect to enter LexDAO address as _arbitrator
    //TODO: update to API3 value
    ...
    function releaseFunds() public {
        require(status == Status.Initial, "Not in Initial state.");
        if (msg.sender != payer)
